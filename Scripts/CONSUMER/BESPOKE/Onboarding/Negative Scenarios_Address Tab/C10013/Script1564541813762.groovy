...
WebUI.setText(findTestObject('CONSUMER/Onboarding/Address Tab/textfield_AddresseeFirstName'), '')

WebUI.setText(findTestObject('CONSUMER/Onboarding/Address Tab/textfield_AddresseeLastName'), 'Doe')

WebUI.setText(findTestObject('CONSUMER/Onboarding/Address Tab/textfield_Address'), 'Residencias de Manila Building 3')
