...
WebUI.setText(findTestObject('Bespoke/Merchant/Upload Page/textfield_ItemName'), 'Test Rearrange Variants')

WebUI.setText(findTestObject('Bespoke/Merchant/Upload Page/textfield_Price'), '10')

WebUI.setText(findTestObject('Bespoke/Merchant/Upload Page/textfield_SKU'), 'Test Rearrange Variants')

WebUI.setText(findTestObject('Bespoke/Merchant/Upload Page/textarea_ItemDescription'), 'Test Rearrange Variants')
