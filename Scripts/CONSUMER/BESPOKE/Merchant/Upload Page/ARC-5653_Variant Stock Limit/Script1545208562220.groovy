...
WebUI.waitForElementVisible(findTestObject('Object Repository/Bespoke/Merchant/Upload Page/dropdown_Category'), 0)

WebUI.selectOptionByLabel(findTestObject('Object Repository/Bespoke/Merchant/Upload Page/dropdown_Category'), 'Category 1', 
    true)

WebUI.setText(findTestObject('Bespoke/Merchant/Upload Page/textfield_ItemName'), 'Test Stock Variants')
...
WebUI.click(findTestObject('Bespoke/Merchant/Upload Page/toggle_Quantity'), FailureHandling.STOP_ON_FAILURE)

WebUI.verifyElementNotClickable(findTestObject('Bespoke/Merchant/Upload Page/textfield_Quantity'), FailureHandling.STOP_ON_FAILURE)
...
WebUI.setText(findTestObject('Bespoke/Merchant/Upload Page/textfield_search-item'), 'Test Stock Variants')
...
WebUI.verifyElementText(findTestObject('Bespoke/Merchant/Upload Page/label_stock_List'), '∞')

WebUI.click(findTestObject('Bespoke/Merchant/Upload Page/button_edit'), FailureHandling.STOP_ON_FAILURE)

WebUI.waitForElementVisible(findTestObject('Object Repository/Bespoke/Merchant/Upload Page/dropdown_Category'), 0)

WebUI.scrollToElement(findTestObject('Bespoke/Merchant/Upload Page/button_deleteImage'), 0)

WebUI.delay(3)

WebUI.click(findTestObject('Bespoke/Merchant/Upload Page/toggle_Quantity'), FailureHandling.STOP_ON_FAILURE)

WebUI.waitForElementClickable(findTestObject('Bespoke/Merchant/Upload Page/textfield_Quantity'), 0)

WebUI.setText(findTestObject('Bespoke/Merchant/Upload Page/textfield_Quantity'), '10')
...
WebUI.verifyElementText(findTestObject('Bespoke/Merchant/Upload Page/label_stockValue_List'), '10')
...
WebUI.waitForElementClickable(findTestObject('Bespoke/Merchant/Upload Page/a_Variants_Table/1_Stock'), 0)

WebUI.setText(findTestObject('Bespoke/Merchant/Upload Page/a_Variants_Table/1_Stock'), '10')

WebUI.setText(findTestObject('Bespoke/Merchant/Upload Page/a_Variants_Table/2_Stock'), '10')

WebUI.setText(findTestObject('Bespoke/Merchant/Upload Page/a_Variants_Table/3_Stock'), '10')
...
WebUI.verifyElementText(findTestObject('Bespoke/Merchant/Upload Page/label_stockValue_List'), '30')

WebUI.setText(findTestObject('Bespoke/Merchant/Upload Page/textfield_search-item'), 'Test Stock Variants')

WebUI.click(findTestObject('Bespoke/Merchant/Item Details Page/button_search'), FailureHandling.STOP_ON_FAILURE)
