...
WebUI.setText(findTestObject('CONSUMER/Search Function/textfield_Keyword'), 'Duration Item')
...
WebUI.waitForElementVisible(findTestObject('CONSUMER/Inbox/button_inbox'), 0)

WebUI.click(findTestObject('CONSUMER/Inbox/button_inbox'))

WebUI.waitForElementVisible(findTestObject('CONSUMER/Inbox/button_Enquiry'), 0)

WebUI.waitForPageLoad(1)

WebUI.setText(findTestObject('CONSUMER/Inbox/textfield_Search'), 'Duration Item')

WebUI.click(findTestObject('CONSUMER/Inbox/button_Search'))
...
WebUI.click(findTestObject('CONSUMER/Inbox/button_Enquiry'), FailureHandling.CONTINUE_ON_FAILURE)

WebUI.waitForElementVisible(findTestObject('CONSUMER/Chat Details Page/button_Send'), 0)

WebUI.waitForElementClickable(findTestObject('CONSUMER/Chat Details Page/textarea_chatMsg'), 0)

WebUI.click(findTestObject('CONSUMER/Chat Details Page/button_CreateOffer'), FailureHandling.CONTINUE_ON_FAILURE)

WebUI.waitForElementVisible(findTestObject('CONSUMER/Chat Details Page/button_sendNow'), 0)

WebUI.scrollToElement(findTestObject('CONSUMER/Item Details Page/datepicker_Date'), 0)
...
WebUI.setText(findTestObject('CONSUMER/Chat Details Page/textfield_Offer'), '9')

WebUI.delay(1)

WebUI.click(findTestObject('CONSUMER/Chat Details Page/button_sendNow'))
...
WebUI.setText(findTestObject('CONSUMER/Inbox/textfield_Search'), 'Custom 15Min Not 24/7')

WebUI.click(findTestObject('CONSUMER/Inbox/button_Search'))

WebUI.delay(1)

WebUI.waitForElementVisible(findTestObject('CONSUMER/Chat Details Page/button_Pending'), 0)

WebUI.click(findTestObject('CONSUMER/Chat Details Page/button_Pending'), FailureHandling.CONTINUE_ON_FAILURE)
...
WebUI.waitForElementVisible(findTestObject('CONSUMER/Chat Details Page/button_BuyNow'), 0)

WebUI.click(findTestObject('CONSUMER/Chat Details Page/button_BuyNow'), FailureHandling.CONTINUE_ON_FAILURE)
