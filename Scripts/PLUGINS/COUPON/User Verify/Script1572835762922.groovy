...
WebUI.click(findTestObject('Coupon_Package/COUPON_PAGE/Page_trishabespoke (2)/Page_trishabespoke/dddelivery'), FailureHandling.CONTINUE_ON_FAILURE)
...
delivery = WebUI.getAttribute(findTestObject('BESPOKE DEL 2/CONSUMER/Review Details Page/dropdown_SelectDeliveryMethod'), 
    'value')
...
def total = (intsubtotal - intdiscount) + println(df.format(new BigDecimal(total)))
