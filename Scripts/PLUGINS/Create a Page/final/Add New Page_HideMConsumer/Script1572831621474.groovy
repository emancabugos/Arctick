...
WebUI.setText(findTestObject('ADMIN/Plugins/Web Page Builder/textfield_PageTitle'), 'merconsumer')
...
WebUI.setText(findTestObject('Utilities/Text Editor Icon/Text Area/text area object/p'), 'merconsumer')
...
navigateurl = (afterURL + 'merconsumer')
