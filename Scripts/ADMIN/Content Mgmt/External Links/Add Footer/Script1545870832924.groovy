...
WebUI.setText(findTestObject('ADMIN/External Links/Footers/input_facebook-text'), 'pickup.seller')

WebUI.setText(findTestObject('ADMIN/External Links/Footers/input_twitter-text'), '01sanchezgem')

WebUI.setText(findTestObject('ADMIN/External Links/Footers/input_instagram-text'), 'sanchezgem01/')

WebUI.setText(findTestObject('ADMIN/External Links/Footers/input_linkedin-text'), 'gem-sanchez-856764141/')

WebUI.click(findTestObject('ADMIN/External Links/Footers/button_Save'), FailureHandling.CONTINUE_ON_FAILURE)
...
WebUI.waitForElementNotPresent(findTestObject('ADMIN/External Links/Success Toaster Message/div_SuccessLinks were succesfu'), 
    0)
