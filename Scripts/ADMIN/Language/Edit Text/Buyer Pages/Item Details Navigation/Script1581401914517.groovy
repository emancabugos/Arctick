...
WebUI.waitForElementVisible(findTestObject('ADMIN/Edit Text/Bespoke/Navigation/textlink_Item Details'), 0)

WebUI.click(findTestObject('ADMIN/Edit Text/Bespoke/Navigation/textlink_Item Details'), FailureHandling.CONTINUE_ON_FAILURE)
