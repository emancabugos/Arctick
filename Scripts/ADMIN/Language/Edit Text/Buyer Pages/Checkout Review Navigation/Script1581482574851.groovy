...
WebUI.waitForElementVisible(findTestObject('ADMIN/Edit Text/Bespoke/Navigation/textlink_Checkout (Order Review)'), 0)

WebUI.click(findTestObject('ADMIN/Edit Text/Bespoke/Navigation/textlink_Checkout (Order Review)'), FailureHandling.CONTINUE_ON_FAILURE)
