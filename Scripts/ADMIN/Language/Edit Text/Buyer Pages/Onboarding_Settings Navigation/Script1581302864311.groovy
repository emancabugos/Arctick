...
WebUI.waitForElementVisible(findTestObject('ADMIN/Edit Text/Bespoke/Navigation/textlink_Onboard  Settings'), 0)

WebUI.click(findTestObject('ADMIN/Edit Text/Bespoke/Navigation/textlink_Onboard  Settings'), FailureHandling.CONTINUE_ON_FAILURE)
