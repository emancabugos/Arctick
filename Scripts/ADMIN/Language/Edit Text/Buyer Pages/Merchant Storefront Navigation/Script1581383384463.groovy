...
WebUI.waitForElementVisible(findTestObject('ADMIN/Edit Text/Bespoke/Navigation/textlink_Merchant Storefront'), 0)

WebUI.click(findTestObject('ADMIN/Edit Text/Bespoke/Navigation/textlink_Merchant Storefront'), FailureHandling.CONTINUE_ON_FAILURE)
