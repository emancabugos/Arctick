...
WebUI.waitForElementVisible(findTestObject('ADMIN/Edit Text/Bespoke/Navigation/textlink_Checkout (Payment)'), 0)

WebUI.click(findTestObject('ADMIN/Edit Text/Bespoke/Navigation/textlink_Checkout (Payment)'), FailureHandling.CONTINUE_ON_FAILURE)
