...
WebUI.waitForElementVisible(findTestObject('ADMIN/Edit Text/Bespoke/Navigation/textlink_Checkout (Delivery Details)'), 0)

WebUI.click(findTestObject('ADMIN/Edit Text/Bespoke/Navigation/textlink_Checkout (Delivery Details)'), FailureHandling.CONTINUE_ON_FAILURE)
