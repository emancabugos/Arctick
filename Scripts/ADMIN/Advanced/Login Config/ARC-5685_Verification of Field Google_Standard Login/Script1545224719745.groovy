...
WebUI.clearText(findTestObject('ADMIN/Advanced/Login Config/textfield_clientID_google2'), FailureHandling.STOP_ON_FAILURE)

WebUI.clearText(findTestObject('ADMIN/Advanced/Login Config/textfield_YourSecretKey_google2'), FailureHandling.STOP_ON_FAILURE)

WebUI.clearText(findTestObject('ADMIN/Advanced/Login Config/textfield_YourSecretKey_google2'), FailureHandling.STOP_ON_FAILURE)

WebUI.setText(findTestObject('ADMIN/Advanced/Login Config/textfield_clientID_google2'), 'test')

WebUI.click(findTestObject('ADMIN/Advanced/Login Config/button_Save_google'))

WebUI.setText(findTestObject('ADMIN/Advanced/Login Config/textfield_YourSecretKey_google2'), 'test')
...
WebUI.setText(findTestObject('ADMIN/Advanced/Login Config/buttoninput_google2'), 'Login with Google')
