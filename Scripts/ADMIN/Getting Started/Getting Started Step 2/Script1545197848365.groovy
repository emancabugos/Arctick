...
WebUI.waitForElementVisible(findTestObject('ADMIN/Getting Started/Step 2/Add Category/Pop Up Window/input_category_name'), 
    0)

WebUI.setText(findTestObject('ADMIN/Getting Started/Step 2/Add Category/Pop Up Window/input_category_name'), 'Category 1')

WebUI.click(findTestObject('ADMIN/Getting Started/Step 2/Add Category/Pop Up Window/div_Browse'))

WebUI.delay(1, FailureHandling.CONTINUE_ON_FAILURE)

WebUI.uploadFile(findTestObject('ADMIN/Getting Started/Step 2/Add Category/Pop Up Window/input_thumb'), 'C:\\\\Katalon\\\\Image\\\\pic1.jpg')

WebUI.waitForElementVisible(findTestObject('ADMIN/Getting Started/Step 2/Add Category/Pop Up Window/div_btn btn-success btn-ok'), 
    0)

WebUI.click(findTestObject('ADMIN/Getting Started/Step 2/Add Category/Pop Up Window/div_btn btn-success btn-ok'))

WebUI.waitForElementVisible(findTestObject('ADMIN/Getting Started/Step 2/Add Category/Pop Up Window/a_Add Photo'), 0)

WebUI.click(findTestObject('ADMIN/Getting Started/Step 2/Add Category/Pop Up Window/a_Add Photo'))

WebUI.waitForElementVisible(findTestObject('ADMIN/Getting Started/Step 2/Add Category/Pop Up Window/input_btnSaveParentCategory'), 
    0)

WebUI.delay(1, FailureHandling.CONTINUE_ON_FAILURE)

WebUI.click(findTestObject('ADMIN/Getting Started/Step 2/Add Category/Pop Up Window/input_btnSaveParentCategory'))
