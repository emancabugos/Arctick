...
WebUI.waitForElementVisible(findTestObject('ADMIN/Item List/label_Select All Merchant'), 0)
...
WebUI.waitForElementVisible(findTestObject('ADMIN/Item List/label_Select All Category'), 0)

WebUI.click(findTestObject('ADMIN/Item List/label_Select All Category'))

WebUI.selectOptionByLabel(findTestObject('ADMIN/Item List/select_Select Stock'), 'All', false)

WebUI.selectOptionByLabel(findTestObject('ADMIN/Item List/select_Select Purchasable'), 'All', false)
