...
WebUI.verifyElementText(findTestObject('ADMIN/Admin Users/Change Password/h5_Change Users Password'), 'Change User\'s Password')

WebUI.verifyElementPresent(findTestObject('ADMIN/Admin Users/Change Password/i_icon icon-close'), 0)

WebUI.verifyElementText(findTestObject('ADMIN/Admin Users/Change Password/label_Enter new password'), 'Enter new password')

WebUI.verifyElementPresent(findTestObject('ADMIN/Admin Users/Change Password/input_NewPassword'), 0)

WebUI.verifyElementText(findTestObject('ADMIN/Admin Users/Change Password/label_Confirm new password'), 'Confirm new password')

WebUI.verifyElementPresent(findTestObject('ADMIN/Admin Users/Change Password/input_confirm_password'), 0)

WebUI.verifyElementPresent(findTestObject('ADMIN/Admin Users/Change Password/button_Save'), 0)

WebUI.verifyElementText(findTestObject('ADMIN/Admin Users/Change Password/button_Save'), 'Save')

WebUI.click(findTestObject('ADMIN/Admin Users/Change Password/i_icon icon-close'))
