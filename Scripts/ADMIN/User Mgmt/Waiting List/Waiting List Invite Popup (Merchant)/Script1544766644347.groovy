...
WebUI.waitForElementVisible(findTestObject('ADMIN/Admin Users/Waiting List/div_Invite Merchants'), 0)
...
WebUI.verifyElementText(findTestObject('ADMIN/Admin Users/Waiting List/div_Invite your Merchant to on'), 'Invite your Merchant to onboard on your marketplace')

WebUI.verifyElementPresent(findTestObject('ADMIN/Admin Users/Waiting List/div_popoup-seller-img'), 0)
...
WebUI.verifyElementText(findTestObject('ADMIN/Admin Users/Waiting List/p_(Use commas separate multipl'), '(Use commas separate multiple recipients).')

WebUI.verifyElementPresent(findTestObject('ADMIN/Admin Users/Waiting List/textarea'), 0)

WebUI.verifyElementPresent(findTestObject('ADMIN/Admin Users/Waiting List/input_mybtn btn-blue'), 0)

WebUI.comment('Click Close invite pop up')

WebUI.click(findTestObject('ADMIN/Admin Users/Waiting List/close_button'))

WebUI.waitForElementNotVisible(findTestObject('ADMIN/Admin Users/Waiting List/div_Invite your Merchant to on'), 0)

WebUI.comment('Invite Merchant Invalid Email')

WebUI.click(findTestObject('ADMIN/Admin Users/Waiting List/div_Invite Merchants'))

WebUI.setText(findTestObject('ADMIN/Admin Users/Waiting List/textarea'), '.abcdefgh@gmail.com')
