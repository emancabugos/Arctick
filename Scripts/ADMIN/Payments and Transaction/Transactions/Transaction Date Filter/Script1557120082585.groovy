...
WebUI.click(findTestObject('ADMIN/Transactions/input_filter_start_date'), FailureHandling.CONTINUE_ON_FAILURE)

WebUI.click(findTestObject('ADMIN/Transactions/input_filter_end_date'), FailureHandling.CONTINUE_ON_FAILURE)

WebUI.click(findTestObject('ADMIN/Transactions/button_Search'), FailureHandling.CONTINUE_ON_FAILURE)

WebUI.click(findTestObject('ADMIN/Transactions/button_Export CSV'), FailureHandling.CONTINUE_ON_FAILURE)

WebUI.delay(1)

WebUI.comment('Manual Input')

WebUI.setText(findTestObject('ADMIN/Transactions/input_filter_start_date'), '06/05/2019')

WebUI.setText(findTestObject('ADMIN/Transactions/input_filter_end_date'), '06/05/2019')
