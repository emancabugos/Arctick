...
if (varCustomFieldType == 'Checkbox') {
    ...
    WebUI.setText(findTestObject('ADMIN/Custom Item Fields Page/a_Checkbox/textfield_option1'), varCustomFieldName + 'CB1')

    WebUI.setText(findTestObject('ADMIN/Custom Item Fields Page/a_Checkbox/textfield_option2'), varCustomFieldName + 'CB2')
    ...
    WebUI.setText(findTestObject('ADMIN/Custom Item Fields Page/a_Checkbox/textfield_opt1'), varCustomFieldName + 'DD1')

    WebUI.setText(findTestObject('ADMIN/Custom Item Fields Page/a_Checkbox/textfield_opt2'), varCustomFieldName + 'DD2')
