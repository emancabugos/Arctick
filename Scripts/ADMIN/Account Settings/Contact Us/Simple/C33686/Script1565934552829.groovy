...
WebUI.verifyElementVisible(findTestObject('ADMIN/Contact Info/logo_ContactInfo'))

WebUI.verifyElementVisible(findTestObject('ADMIN/Contact Info/toggle_contactUs'))
