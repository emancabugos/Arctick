...
WebUI.click(findTestObject('ADMIN/Language/Edit Text/button_AdminPages'), FailureHandling.CONTINUE_ON_FAILURE)

WebUI.waitForElementVisible(findTestObject('ADMIN/Language/Admin Pages/linktext_CustomFields'), 0)

WebUI.click(findTestObject('ADMIN/Language/Admin Pages/linktext_CustomFields'), FailureHandling.CONTINUE_ON_FAILURE)
