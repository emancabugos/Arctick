...
WebUI.waitForElementVisible(findTestObject('Stripe Login/skip_step'), 0)

WebUI.click(findTestObject('Stripe Login/skip_step'), FailureHandling.CONTINUE_ON_FAILURE)
...
WebUI.comment('view test data')

WebUI.waitForElementVisible(findTestObject('Stripe Login/view_test data'), 0)

WebUI.click(findTestObject('Stripe Login/view_test data'), FailureHandling.CONTINUE_ON_FAILURE)
