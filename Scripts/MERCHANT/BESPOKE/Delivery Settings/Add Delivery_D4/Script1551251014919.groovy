...
WebUI.setText(findTestObject('MERCHANT/Bespoke/Delivery Settings/Add Edit Delivery Option/dd_coutnry'), 'Australia')

WebUI.waitForElementVisible(findTestObject('MERCHANT/Bespoke/Delivery Settings/Add Edit Delivery Option/Add Delivery Rate/checkbox_AU'), 
    0)

WebUI.click(findTestObject('MERCHANT/Bespoke/Delivery Settings/Add Edit Delivery Option/Add Delivery Rate/checkbox_AU'), 
