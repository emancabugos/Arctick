...
WebUI.setText(findTestObject('BESPOKE/MERCHANT/Upload Page (1)/input_item-name'), 'Item Name')
...
WebUI.verifyElementAttributeValue(findTestObject('BESPOKE/MERCHANT/Upload Page (1)/textbox_category-name'), 'value', '', 0)
