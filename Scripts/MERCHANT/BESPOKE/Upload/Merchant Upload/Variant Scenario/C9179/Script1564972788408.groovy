...
WebUI.setText(findTestObject('BESPOKE/MERCHANT/Upload Page (1)/input_item-name'), 'C9179')

WebUI.setText(findTestObject('BESPOKE/MERCHANT/Upload Page (1)/textbox_item-price'), '10')

WebUI.setText(findTestObject('BESPOKE/MERCHANT/Upload Page (1)/textbox_sku-field'), 'C9179SKU')
...
WebUI.setText(findTestObject('BESPOKE/MERCHANT/Upload Page (1)/Variants/textbox_choices1'), '1,')
