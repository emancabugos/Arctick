...
WebUI.setText(findTestObject('MERCHANT/Bespoke/Upload Page/input_item-name'), 'C9179')

WebUI.setText(findTestObject('MERCHANT/Bespoke/Upload Page/textbox_item-price'), '10')

WebUI.setText(findTestObject('MERCHANT/Bespoke/Upload Page/textbox_sku-field'), 'C9179SKU')
...
WebUI.setText(findTestObject('MERCHANT/Bespoke/Upload Page/Variants/textbox_choices1'), '1,')
