...
WebUI.setText(findTestObject('BESPOKE/MERCHANT/Upload Page (1)/input_item-name'), 'C9173')

WebUI.setText(findTestObject('BESPOKE/MERCHANT/Upload Page (1)/textbox_item-price'), '10')

WebUI.setText(findTestObject('BESPOKE/MERCHANT/Upload Page (1)/textbox_sku-field'), 'C9173SKU')
...
WebUI.setText(findTestObject('BESPOKE/MERCHANT/Upload Page (1)/Variants/textbox_opt1'), 'A')
