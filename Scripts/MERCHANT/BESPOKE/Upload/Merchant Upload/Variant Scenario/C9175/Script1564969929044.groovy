...
WebUI.setText(findTestObject('Bespoke/Merchant/Upload Page (1)/input_item-name'), 'C9175')

WebUI.setText(findTestObject('Bespoke/Merchant/Upload Page (1)/textbox_item-price'), '10')

WebUI.setText(findTestObject('Bespoke/Merchant/Upload Page (1)/textbox_sku-field'), 'C9175SKU')
...
WebUI.setText(findTestObject('Bespoke/Merchant/Upload Page (1)/Variants/textbox_opt1'), ' ')
...
WebUI.verifyElementAttributeValue(findTestObject('Bespoke/Merchant/Upload Page (1)/Variants/textbox_opt1'), 'value', ' ', 0)
