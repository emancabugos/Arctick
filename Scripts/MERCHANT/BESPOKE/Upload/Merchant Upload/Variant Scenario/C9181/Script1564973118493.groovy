...
WebUI.setText(findTestObject('Bespoke/Merchant/Upload Page (1)/input_item-name'), 'C9181')

WebUI.setText(findTestObject('Bespoke/Merchant/Upload Page (1)/textbox_item-price'), '10')

WebUI.setText(findTestObject('Bespoke/Merchant/Upload Page (1)/textbox_sku-field'), 'C9181SKU')
...
WebUI.sendKeys(findTestObject('Bespoke/Merchant/Upload Page (1)/Variants/textbox_choices1'), Keys.chord(Keys.BACK_SPACE))
...
WebUI.verifyElementAttributeValue(findTestObject('Bespoke/Merchant/Upload Page (1)/Variants/textbox_choices1'), 'value', '', 
    0)
