...
WebUI.setText(findTestObject('BESPOKE/MERCHANT/Upload Page (1)/input_item-name'), 'C9177')

WebUI.setText(findTestObject('BESPOKE/MERCHANT/Upload Page (1)/textbox_item-price'), '10')

WebUI.setText(findTestObject('BESPOKE/MERCHANT/Upload Page (1)/textbox_sku-field'), 'C9177SKU')
...
WebUI.setText(findTestObject('BESPOKE/MERCHANT/Upload Page (1)/Variants/textbox_opt1'), 'ALPHA1234567890')
