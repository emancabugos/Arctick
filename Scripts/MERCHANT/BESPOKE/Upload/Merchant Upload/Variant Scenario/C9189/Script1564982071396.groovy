...
WebUI.setText(findTestObject('MERCHANT/Bespoke/Upload Page/input_item-name'), 'C9181')

WebUI.setText(findTestObject('MERCHANT/Bespoke/Upload Page/textbox_item-price'), '10')

WebUI.setText(findTestObject('MERCHANT/Bespoke/Upload Page/textbox_sku-field'), 'C9181SKU')
...
WebUI.sendKeys(findTestObject('MERCHANT/Bespoke/Upload Page/Variants/textbox_choices1'), Keys.chord(Keys.BACK_SPACE))

WebUI.setText(findTestObject('MERCHANT/Bespoke/Upload Page/Variants/stock'), '1')

WebUI.setText(findTestObject('MERCHANT/Bespoke/Upload Page/Variants/stock2'), '1')

WebUI.click(findTestObject('MERCHANT/Bespoke/Upload Page/button_SAVE'), FailureHandling.CONTINUE_ON_FAILURE)

WebUI.verifyElementAttributeValue(findTestObject('MERCHANT/Bespoke/Upload Page/Variants/textbox_choices1'), 'value', '', 
    0)
