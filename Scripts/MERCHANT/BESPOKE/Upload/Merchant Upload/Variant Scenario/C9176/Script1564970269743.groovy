...
WebUI.setText(findTestObject('MERCHANT/Bespoke/Upload Page/input_item-name'), 'C9176')

WebUI.setText(findTestObject('MERCHANT/Bespoke/Upload Page/textbox_item-price'), '10')

WebUI.setText(findTestObject('MERCHANT/Bespoke/Upload Page/textbox_sku-field'), 'C9176SKU')
...
WebUI.setText(findTestObject('MERCHANT/Bespoke/Upload Page/Variants/textbox_opt1'), 'SPECIAL!@#$%^&*()')
