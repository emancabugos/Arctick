...
WebUI.setText(findTestObject('MERCHANT/Bespoke/Upload Page/input_item-name'), 'C9171')

WebUI.setText(findTestObject('MERCHANT/Bespoke/Upload Page/textbox_item-price'), '10')

WebUI.setText(findTestObject('MERCHANT/Bespoke/Upload Page/textbox_sku-field'), 'C9171SKU')
...
WebUI.setText(findTestObject('MERCHANT/Bespoke/Upload Page/Variants/textbox_opt1'), ' ')
...
WebUI.verifyElementAttributeValue(findTestObject('MERCHANT/Bespoke/Upload Page/Variants/textbox_opt1'), 'value', ' ', 0)
