...
WebUI.setText(findTestObject('MERCHANT/Bespoke/Upload Page/input_item-name'), 'C9194')

WebUI.setText(findTestObject('MERCHANT/Bespoke/Upload Page/textbox_item-price'), '10')

WebUI.setText(findTestObject('MERCHANT/Bespoke/Upload Page/textbox_sku-field'), 'CSKU')
...
WebUI.setText(findTestObject('MERCHANT/Bespoke/Upload Page/Variants/vSKU1'), 'CSKU')
