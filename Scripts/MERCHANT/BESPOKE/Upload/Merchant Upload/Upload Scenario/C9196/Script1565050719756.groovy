...
WebUI.setText(findTestObject('MERCHANT/Bespoke/Upload Page/input_item-name'), 'C9195')

WebUI.setText(findTestObject('MERCHANT/Bespoke/Upload Page/textbox_item-price'), '10')

WebUI.setText(findTestObject('MERCHANT/Bespoke/Upload Page/textbox_sku-field'), 'C9195SKU!@#$%^&')
...
WebUI.setText(findTestObject('MERCHANT/Bespoke/Upload Page/Variants/vSKU1'), 'C9195VAR!@#$%^&*(')
