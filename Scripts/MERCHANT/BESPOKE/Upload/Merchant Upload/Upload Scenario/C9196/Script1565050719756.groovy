...
WebUI.setText(findTestObject('Bespoke/Merchant/Upload Page (1)/input_item-name'), 'C9195')

WebUI.setText(findTestObject('Bespoke/Merchant/Upload Page (1)/textbox_item-price'), '10')

WebUI.setText(findTestObject('Bespoke/Merchant/Upload Page (1)/textbox_sku-field'), 'C9195SKU!@#$%^&')
...
WebUI.setText(findTestObject('Bespoke/Merchant/Upload Page (1)/Variants/vSKU1'), 'C9195VAR!@#$%^&*(')
