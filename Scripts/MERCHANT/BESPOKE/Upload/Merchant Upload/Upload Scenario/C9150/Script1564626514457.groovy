...
WebUI.setText(findTestObject('Bespoke/Merchant/Upload Page (1)/input_item-name'), 'ITEM')
...
WebUI.setText(findTestObject('Bespoke/Merchant/Upload Page (1)/textarea_item-description'), 'DESCRIPTION')
...
WebUI.setText(findTestObject('Bespoke/Merchant/Upload Page (1)/textbox_item-quantity'), ' ')

WebUI.click(findTestObject('Bespoke/Merchant/Upload Page (1)/button_SAVE'), FailureHandling.CONTINUE_ON_FAILURE)

WebUI.verifyElementAttributeValue(findTestObject('Bespoke/Merchant/Upload Page (1)/textbox_item-quantity'), 'value', '', 0)
