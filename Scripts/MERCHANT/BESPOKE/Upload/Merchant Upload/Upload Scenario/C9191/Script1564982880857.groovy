...
WebUI.setText(findTestObject('MERCHANT/Bespoke/Upload Page/Variants/textbox_choices1'), '20Characte,')

WebUI.verifyElementPresent(findTestObject('MERCHANT/Bespoke/Upload Page/Variants/vSKU1'), 0)
