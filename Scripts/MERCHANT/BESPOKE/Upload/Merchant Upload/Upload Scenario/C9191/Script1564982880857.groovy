...
WebUI.setText(findTestObject('Bespoke/Merchant/Upload Page (1)/Variants/textbox_choices1'), '20Characte,')

WebUI.verifyElementPresent(findTestObject('Bespoke/Merchant/Upload Page (1)/Variants/vSKU1'), 0)
