...
WebUI.setText(findTestObject('MERCHANT/Change Password/input_oldpassword'), 'invalid')
...
WebUI.verifyElementPresent(findTestObject('MERCHANT/Change Password/invalid_login'), 0)
