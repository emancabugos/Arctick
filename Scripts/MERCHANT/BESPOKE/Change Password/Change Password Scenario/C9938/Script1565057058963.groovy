...
WebUI.setText(findTestObject('MERCHANT/Change Password/input_newpassword'), 'Welcome08!')

WebUI.setText(findTestObject('MERCHANT/Change Password/input_confirmnewpassword'), 'Welcome08!')
