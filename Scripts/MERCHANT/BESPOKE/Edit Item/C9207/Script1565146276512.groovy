...
WebUI.click(findTestObject('MERCHANT/Custom Fields/custom-time'), FailureHandling.CONTINUE_ON_FAILURE)

WebUI.setText(findTestObject('MERCHANT/Custom Fields/custom-date'), '06/08/3000')
