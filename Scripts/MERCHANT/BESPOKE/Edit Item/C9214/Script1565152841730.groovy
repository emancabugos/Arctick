...
WebUI.setText(findTestObject('MERCHANT/Bespoke/Upload Page/textbox_item-price'), '!@#$%ABCDE')

WebUI.delay(1)

WebUI.click(findTestObject('MERCHANT/Bespoke/Upload Page/button_SAVE'), FailureHandling.CONTINUE_ON_FAILURE)

WebUI.verifyElementAttributeValue(findTestObject('MERCHANT/Bespoke/Upload Page/textbox_item-price'), 'value', '', 0)
