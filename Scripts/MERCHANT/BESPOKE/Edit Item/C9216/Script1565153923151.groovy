...
WebUI.setText(findTestObject('MERCHANT/Custom Fields/custom-email'), 'sinvalid--@')

WebUI.delay(1)

WebUI.click(findTestObject('MERCHANT/Bespoke/Upload Page/button_SAVE'), FailureHandling.CONTINUE_ON_FAILURE)

WebUI.verifyElementAttributeValue(findTestObject('MERCHANT/Custom Fields/custom-email'), 'value', 'sinvalid--@', 0)
