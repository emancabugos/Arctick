...
WebUI.setText(findTestObject('MERCHANT/Custom Fields/percentage'), '')

WebUI.delay(1)

WebUI.click(findTestObject('Bespoke/Merchant/Upload Page (1)/button_SAVE'), FailureHandling.CONTINUE_ON_FAILURE)

WebUI.verifyElementAttributeValue(findTestObject('MERCHANT/Custom Fields/percentage'), 'value', '', 0)
