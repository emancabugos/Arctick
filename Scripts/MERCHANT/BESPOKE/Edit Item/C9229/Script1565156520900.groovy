...
WebUI.setText(findTestObject('MERCHANT/Custom Fields/custom-date'), '')

WebUI.setText(findTestObject('MERCHANT/Custom Fields/custom-time'), '')

WebUI.delay(1)

WebUI.click(findTestObject('Bespoke/Merchant/Upload Page (1)/button_SAVE'), FailureHandling.CONTINUE_ON_FAILURE)

WebUI.verifyElementAttributeValue(findTestObject('MERCHANT/Custom Fields/custom-time'), 'value', '', 0)

WebUI.verifyElementAttributeValue(findTestObject('MERCHANT/Custom Fields/custom-date'), 'value', '', 0)
