...
WebUI.click(findTestObject('MERCHANT/Category/Bespoke/Category 1'))

WebUI.setText(findTestObject('Bespoke/Merchant/Upload Page (1)/input_item-name'), 'FOR EDIT')

WebUI.setText(findTestObject('Bespoke/Merchant/Upload Page (1)/textbox_item-price'), '10')

WebUI.setText(findTestObject('Bespoke/Merchant/Upload Page (1)/textbox_sku-field'), '9193')
...
WebUI.setText(findTestObject('Bespoke/Merchant/Upload Page (1)/Variants/vSKU1'), '9193')
