...
WebUI.setText(findTestObject('MERCHANT/Bespoke/Merchant Onboarding/Profile Page/Profile/textbox_FirstName'), '')
...
WebUI.verifyElementAttributeValue(findTestObject('MERCHANT/Bespoke/Merchant Onboarding/Profile Page/Profile/textbox_FirstName'), 
    'value', '', 0)
