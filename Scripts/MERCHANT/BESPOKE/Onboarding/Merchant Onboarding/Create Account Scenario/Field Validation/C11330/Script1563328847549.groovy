...
WebUI.setText(findTestObject('MERCHANT/Bespoke/Merchant Onboarding/Create Account/textbox_username'), ' ')
...
WebUI.verifyElementAttributeValue(findTestObject('MERCHANT/Bespoke/Merchant Onboarding/Create Account/textbox_username'), 
    'value', ' ', 0)
