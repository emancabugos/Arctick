...
WebUI.setText(findTestObject('MERCHANT/Bespoke/Merchant Onboarding/Create Account/textbox_notificationemail'), '')
...
WebUI.verifyElementAttributeValue(findTestObject('MERCHANT/Bespoke/Merchant Onboarding/Create Account/textbox_notificationemail'), 
    'value', '', 0)
