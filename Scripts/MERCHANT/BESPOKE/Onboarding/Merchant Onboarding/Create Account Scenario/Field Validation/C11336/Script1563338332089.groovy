...
WebUI.setText(findTestObject('MERCHANT/Bespoke/Merchant Onboarding/Create Account/textbox_password'), 'mismatch')

WebUI.setText(findTestObject('MERCHANT/Bespoke/Merchant Onboarding/Create Account/textbox_reconfirm-password'), '')
