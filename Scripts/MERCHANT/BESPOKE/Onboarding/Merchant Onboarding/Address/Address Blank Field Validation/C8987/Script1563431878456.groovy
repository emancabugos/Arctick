...
WebUI.setText(findTestObject('Bespoke/Merchant/Merchant Onboarding/Address Page/Address/textbox_first-name'), '')
...
WebUI.verifyElementAttributeValue(findTestObject('Bespoke/Merchant/Merchant Onboarding/Address Page/Address/textbox_first-name'), 
    'value', '', 0)
