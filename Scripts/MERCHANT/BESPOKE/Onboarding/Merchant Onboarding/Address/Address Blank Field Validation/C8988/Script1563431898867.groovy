...
WebUI.setText(findTestObject('Bespoke/Merchant/Merchant Onboarding/Address Page/Address/textbox_last-name'), '')
...
WebUI.verifyElementAttributeValue(findTestObject('Bespoke/Merchant/Merchant Onboarding/Address Page/Address/textbox_last-name'), 
    'value', '', 0)
