...
WebUI.waitForElementVisible(findTestObject('SPACETIME/MERCHANT/Listing Page/header_Your Services'), 0)

WebUI.click(findTestObject('SPACETIME/MERCHANT/Listing Page/header_Your Services'), FailureHandling.CONTINUE_ON_FAILURE)

WebUI.waitForElementVisible(findTestObject('SPACETIME/MERCHANT/Listing Page/button_Add listings'), 0)

WebUI.click(findTestObject('SPACETIME/MERCHANT/Listing Page/button_Add listings'), FailureHandling.CONTINUE_ON_FAILURE)

WebUI.comment('Select Category')

if (varCategory == 'Category 1') {
    WebUI.setText(findTestObject('BESPOKE/MERCHANT/Item Upload/searchbar_category-name'), varCategory)
...
if (varUnlimitedBookings == 'yes') {
    ...
    WebUI.click(findTestObject('SPACETIME/MERCHANT/Service Creation/Basic Details/Toggle/span_onoffswitch-switch'))
} else if (varUnlimitedBookings == 'no') {
    WebUI.verifyElementPresent(findTestObject('SPACETIME/MERCHANT/Service Creation/Basic Details/Toggle/span_onoffswitch-switch'), 
        0)
}
...
if (varOperation == '24/7') {
    WebUI.verifyElementPresent(findTestObject('SPACETIME/MERCHANT/Service Creation/Schedule/247 toggle/span_onoffswitch-switch'), 
        ...
        WebUI.setText(findTestObject('SPACETIME/MERCHANT/Service Creation/Schedule/Operating Hours/mon_st'), '')
    } else if (varSchedule == '7AM - 10PM') {
        WebUI.click(findTestObject('SPACETIME/MERCHANT/Service Creation/Schedule/247 toggle/span_onoffswitch-switch'))
...
WebUI.setText(findTestObject('SPACETIME/MERCHANT/Service Creation/Schedule/select_st_date'), '25/12/2019')

WebUI.setText(findTestObject('SPACETIME/MERCHANT/Service Creation/Schedule/select_en_date'), '31/12/2019')
